...
class _ApiServices implements ApiServices {
  ...
  @override
  Future<LoginModel> login(Map<String, dynamic> userData) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<LoginModel> register(Map<String, dynamic> userData) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<RefreshAccessTokenResponseModel> refreshAccessToken(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<RefreshAccessTokenResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = RefreshAccessTokenResponseModel.fromJson(_result.data!);
    return value;
  }

  @override
  Future<List<TaskModel>> getListOfTasks(int page) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<dynamic> deleteTask(dynamic tokenId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<TaskModel> getTask(dynamic taskId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<TaskModel> addNewTask(Map<String, dynamic> task) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<UploadImageResponseModel> uploadImage(File file) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UploadImageResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    ...
    final value = UploadImageResponseModel.fromJson(_result.data!);
    return value;
  }
