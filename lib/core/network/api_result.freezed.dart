...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ErrorModel networkExceptions) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ErrorModel networkExceptions)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$ErrorImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({ErrorModel networkExceptions});
}
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  final ErrorModel networkExceptions;

  @override
  String toString() {
    return 'ApiResult<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements ApiResult<T> {
  const factory Error(final ErrorModel networkExceptions) = _$ErrorImpl<T>;

  ErrorModel get networkExceptions;
  @JsonKey(ignore: true)
  _$$ErrorImplCopyWith<T, _$ErrorImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
